...
+ '  <img v-if="speaker.photo" :src="\'/images/speakers/\' + speaker.photo" class="devfest-speaker-card-img" />'
+ '</div>'
+ '<div class="devfest-speaker-card-content">'
+ '  <div class="devfest-speaker-card-title">'
+ '    <img v-if="speaker.photo" :src="\'/images/speakers/\' + speaker.photo" class="devfest-speaker-card-img-sm mdl-cell--hide-tablet mdl-cell--hide-desktop" />'
+ '    <div>'
